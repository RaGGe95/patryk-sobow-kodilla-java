package com.kodilla.stream.part7_4.invoice.simple;
...
public class SimpleInvoiceTestSuite {
    ...
    public void testGetValueToPay() {
        ...
        //Then
        Assert.assertEquals(108.975, invoice.getValueToPay(), 0.00001);
        // Dla liczb typu double używamy wersji metody assertEquals(expected, actual, detlta)
    }
}