...
public class TankOrderDecorator extends AbstractTaxiOrderDecorator {
    public TankOrderDecorator(TaxiOrder taxiOrder) {
        super(taxiOrder);
    }

    @Override
    public BigDecimal getCost() {
        return super.getCost().add(new BigDecimal(5000));
    }

    @Override
    public String getDescription() {
        return super.getDescription() + " by Tank";
    }
}
